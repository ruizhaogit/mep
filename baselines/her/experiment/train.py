...
@click.command()
@click.option('--env_name', type=click.Choice(['FetchPickAndPlace-v0', 'FetchSlide-v0', 'FetchPush-v0', 'HandManipulateBlockFull-v0', \
        'HandManipulateEggFull-v0','HandManipulatePenRotate-v0']), default='FetchPickAndPlace-v0', help='the name of the OpenAI\
